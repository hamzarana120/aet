...
class dphrases extends StatefulWidget {
  @override
  _dphrasesState createState() => _dphrasesState();
}

class _dphrasesState extends State<dphrases> {
                        ...
                        child: PageView(
                          ...
                          children: <Widget>[
                            ...
                            InkWell(
                              ...
                              onTap: () {
                                final player = AudioCache();
                                player.play('dphrasev/dinosaur.mp3');
                              },
                            ),
                            InkWell(
                              child: Container(
                              ...
                              onTap: () {
                                final player = AudioCache();
                                player.play('dphrasev/dolphin.mp3');
                              },
                            ),
                            InkWell(
                              child: Container(
                              ...
                              onTap: () {
                                final player = AudioCache();
                                player.play('dphrasev/donkey.mp3');
                              },
                            ),
                            InkWell(
                              child: Container(
                            ...
                            InkWell(
                              ...
                              onTap: () {
                                final player = AudioCache();
                                player.play('dphrasev/dragon.mp3');
                              },
                            ),
                            InkWell(
                              child: Container(
