...
class bphrases extends StatefulWidget {
  @override
  _bphrasesState createState() => _bphrasesState();
}

class _bphrasesState extends State<bphrases> {
                        ...
                        child: PageView(
                          ...
                          children: <Widget>[
                            ...
                            InkWell(
                              ...
                              onTap: () {
                                final player = AudioCache();
                                player.play('bphrasev/bread.mp3');
                              },
                            ),
                            InkWell(
                              child: Container(
                              ...
                              onTap: () {
                                final player = AudioCache();
                                player.play('bphrasev/balloon.mp3');
                              },
                            ),
                            InkWell(
                              child: Container(
                              ...
                              onTap: () {
                                final player = AudioCache();
                                player.play('bphrasev/basket.mp3');
                              },
                            ),
                            InkWell(
                              child: Container(
                            ...
                            InkWell(
                              ...
                              onTap: () {
                                final player = AudioCache();
                                player.play('bphrasev/bottle.mp3');
                              },
                            ),
                            InkWell(
                              child: Container(
                              ...
                              onTap: () {
                                final player = AudioCache();
                                player.play('bphrasev/bicycle.mp3');
                              },
                            ),
                            InkWell(
                              child: Container(
