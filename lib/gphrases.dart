...
class gphrases extends StatefulWidget {
  @override
  _gphrasesState createState() => _gphrasesState();
}

class _gphrasesState extends State<gphrases> {
