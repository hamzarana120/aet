...
class fwords extends StatefulWidget {
  @override
  _fwordsState createState() => _fwordsState();
}

class _fwordsState extends State<fwords> {
                        ...
                        child: PageView(
                          ...
                          children: <Widget>[
                            ...
                            InkWell(
                              ...
                              onTap: () {
                                final player = AudioCache();
                                player.play('fword/football.mp3');
                              },
                            ),
                          ],
                        )),
